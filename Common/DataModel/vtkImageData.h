...
public:
  ...
  //@{
  /**
   * Get the index to physical transform of the dataset. It is a 4 by 4 matrix which
   * encapsulated the spacing, the origin and the direction
   */
  void GetIndexToPhysicalMatrix(vtkMatrix4x4* indexToPhysical);
  void GetPhysicalToIndexMatrix(vtkMatrix4x4* physicalToIndex);
