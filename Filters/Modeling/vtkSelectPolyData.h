...
protected:
  ...
  void FillMarksInRegion(vtkPolyData* mesh, vtkIdList* edgePointIds, vtkIntArray * pointMarks, vtkIntArray* cellMarks,
...
private:
  ...
  // Helper function to check if the edge between pointId1 and pointId2 is present in the edgePointIds
  // (as direct neighbors).
